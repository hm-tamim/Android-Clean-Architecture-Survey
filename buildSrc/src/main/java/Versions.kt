object Versions {
    const val BUILD_GRADLE_VERSION = "7.1.2"
    ...
    const val ANDROIDX_LIFECYCLE_VERSION = "2.5.0-alpha05"
    const val ANDROIDX_LIFECYCLE_VIEWMODEL_VERSION = "2.4.1"
    const val ANDROIDX_NAVIGATION_VERSION = "2.3.4"
    const val ANDROIDX_SUPPORT_VERSION = "1.4.1"
